...
## Reusable Lessons (suimi)

### post-fix retest confirmed BFLA and sensitive field inventory

- status: promoted
- purpose_zh: 维护后回归时先重放已确认越权点，并检查响应是否新增密钥/邮箱/订单等敏感字段，避免只看 HTTP 状态误判已修复
- source_id: 20260715-214000-post-fix-retest-confirmed-bfla-and-sensitive
