...
- [expression-language-injection](../expression-language-injection/MODULE.md) when `${7*7}` or `%{7*7}` resolves in Java (SpEL/OGNL) — different attack surface from template engines
