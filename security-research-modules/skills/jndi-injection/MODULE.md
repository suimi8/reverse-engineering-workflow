...
- [deserialization-insecure](../deserialization-insecure/MODULE.md) when JNDI leads to deserialization (post-8u191 bypass path)
- [expression-language-injection](../expression-language-injection/MODULE.md) when the JNDI sink is reached via SpEL or OGNL expression evaluation
