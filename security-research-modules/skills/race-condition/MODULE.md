...
**中文路由小结**：若场景更偏「业务规则 / 定价 / 工作流跳过」，加载 `skills/business-logic-vulnerabilities/MODULE.md`；本文件专注 **并发与传输层同步**。

---

## Related

- **business-logic-vulnerabilities** — workflow, coupon abuse, and logic-first checklists (`../business-logic-vulnerabilities/MODULE.md`).
