...
- [path traversal lfi](../path-traversal-lfi/MODULE.md) when filename, extraction path, or include path becomes file-system control
- [xss cross site scripting](../xss-cross-site-scripting/MODULE.md) when uploads are rendered in browser contexts
- [xxe xml external entity](../xxe-xml-external-entity/MODULE.md) when SVG, OOXML, or XML imports are accepted
- [cmdi command injection](../cmdi-command-injection/MODULE.md) when a processor, converter, or media pipeline executes system tools
- [business logic vulnerabilities](../business-logic-vulnerabilities/MODULE.md) when quotas, overwrite rules, approvals, or storage paths create logic bugs
...
| Observation | Pivot |
|---|---|
| SVG or XML accepted | [xxe xml external entity](../xxe-xml-external-entity/MODULE.md) |
| filename or metadata reflected | [xss cross site scripting](../xss-cross-site-scripting/MODULE.md) |
| converter or processor shells out | [cmdi command injection](../cmdi-command-injection/MODULE.md) |
| extraction path looks controllable | [path traversal lfi](../path-traversal-lfi/MODULE.md) |
| overwrite, quota, approval, or tenant bug | [business logic vulnerabilities](../business-logic-vulnerabilities/MODULE.md) |
