...
- [ssti-server-side-template-injection](../ssti-server-side-template-injection/MODULE.md) for template engines (Jinja2, FreeMarker, Twig) — different attack surface
- [jndi-injection](../jndi-injection/MODULE.md) when EL evaluation leads to JNDI lookup
