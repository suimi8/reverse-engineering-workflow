...
- [IDOR Broken Object Authorization](../idor-broken-object-authorization/MODULE.md)
- [CMDi Command Injection](../cmdi-command-injection/MODULE.md)
- [Path Traversal LFI](../path-traversal-lfi/MODULE.md)
- [CSRF Cross Site Request Forgery](../csrf-cross-site-request-forgery/MODULE.md)
- [API Security Router](../api-sec/MODULE.md)
- [JWT OAuth Token Attacks](../jwt-oauth-token-attacks/MODULE.md)
- [OAuth OIDC Misconfiguration](../oauth-oidc-misconfiguration/MODULE.md)
- [CORS Cross Origin Misconfiguration](../cors-cross-origin-misconfiguration/MODULE.md)
- [SAML SSO Assertion Attacks](../saml-sso-assertion-attacks/MODULE.md)
- [Authentication Bypass](../authbypass-authentication-flaws/MODULE.md)
- [Business Logic Vulnerabilities](../business-logic-vulnerabilities/MODULE.md)
- [Upload Insecure Files](../upload-insecure-files/MODULE.md)
...
- [Type Juggling (PHP)](../type-juggling/MODULE.md)
- [HTTP Parameter Pollution](../http-parameter-pollution/MODULE.md)
- [Race Condition](../race-condition/MODULE.md)
- [XSLT Injection](../xslt-injection/MODULE.md)
- [Insecure Source Code Management](../insecure-source-code-management/MODULE.md)
