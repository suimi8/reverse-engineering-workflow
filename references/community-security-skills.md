...
> 本包身份：路由 + 工具自举 + 证据/scope 契约 + field-journal（见 `references/ops/IDENTITY.md`）。
...
| [trilwu/secskills](https://github.com/trilwu/secskills) | 16 skills + 6 专家 subagent | 多角色分工可对标 `references/ops/role-map.md` | 插件形态，与本包 monorepo 不同 |
...
| [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings) | Web payload + Prompt Injection 章节 | `security-research-modules/skills/` 优先；LLM 见 `llm-security` |
...
| 来源 | 要点 | 本包落点 |
|------|------|----------|
| [OWASP Agentic Skills Top 10](https://owasp.org/www-project-agentic-skills-top-10/) | 恶意 skill、供应链、权限滥用、记忆投毒等 | `references/ops/skill-supply-chain.md` |
...
| 证据/scope/角色 | **references/ops/**（特色） | 多数 skill 包没有 case 契约 |
...
6. 安装/合并前走 references/ops/skill-supply-chain.md 清单
...
| 授权侦察 | `security-research-modules/skills/recon-for-sec/MODULE.md` |
| 攻击链门闩 | `security-research-modules/skills/attack-chain/MODULE.md` |
| Skill 供应链 | `references/ops/skill-supply-chain.md` |
