...
function suimiGet-RequiredToolSpec {
    param(
        [Parameter(Mandatory = $true)]
        [string]$Name
    )
...
$rabin2 = suimiGet-RequiredToolSpec -Name 'rabin2'
$r2 = $null
if ($RunAnalysis) {
    $r2 = suimiGet-RequiredToolSpec -Name 'r2'
}
