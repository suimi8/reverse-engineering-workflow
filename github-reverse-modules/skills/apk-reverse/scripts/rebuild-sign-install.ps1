...
function suimiEnsure-DebugKeystore {
    param(
...
$apktool = suimiGet-ToolPath -Name 'apktool'
$zipalign = suimiGet-ToolPath -Name 'zipalign'
$apksigner = suimiGet-ToolPath -Name 'apksigner'
$keytool = suimiGet-ToolPath -Name 'keytool'
$adb = suimiGet-ToolPath -Name 'adb'

suimiEnsure-DebugKeystore -Path $KeystorePath -Keytool $keytool -Alias $KeyAlias -StorePassword $StorePass -KeyPassword $KeyPass
