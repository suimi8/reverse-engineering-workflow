...
- 通用逆向方法论 → `reverse-engineering/MODULE.md`
...
### APK smali helper injection with dex-limit-safe class placement

- source: `20260608-022047-apk-smali-helper-injection-with-dex-limit-safe-c`
- category: method
